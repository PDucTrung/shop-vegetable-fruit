export const products = [
  ...
  },
  {
    ...
    weight: 300,
    description:
      "The Alphonso is a seasonal fruit, available mid-April through the end of June. The fruits generally weigh between 150 and 300 grams (5.3 and 10.6 oz), have a rich, creamy, tender texture and delicate, non-fibrous, juicy pulp.",
  },
  {
    name: "Avocado",
  ...
  },
  {
    ...
    weight: 360,
    description:
      "Eggplant is usually grown as an annual and features an erect bushy stem that is sometimes armed with spines. The leaves are large, ovate, and slightly lobed. The pendant violet flowers are characteristically solitary and approximately 5 cm (2 inches) across.",
  },
  {
    ...
    weight: 410,
    description:
      "Black Globe grapes are jet black in color and have a snappy, crunchy texture. Their high sugar level makes them a delicious healthy snack. With their jumbo berry size, large tapered clusters, and beautiful color, they're a natural work of art.",
  },
  {
    ...
    weight: 400,
    description:
      "A medium, seedless grape with a pale green to pale yellow color. The flesh is very crisp, almost crunchy, and the flavor is mild. The texture and sweetness make this a favorite grape.",
  },
  {
  ...
  },
  {
    ...
    weight: 230,
    description:
      "Radish is an annual vegetable belonging to the family Cruciferae and is a traditionally important vegetable in many countries. The enlarged root and hypocotyl of radish are consumed mainly as a salted vegetable and are also eaten fresh as grated radish, garnish, and salad.",
  },
  {
    name: "Watermelon",
